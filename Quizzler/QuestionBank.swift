...
class QuestionBank{
    ...
    init(){
        ...
        list.append(Question(text: "Are you a virgin?", correctAnswer: true))

        list.append(Question(text: "Are you living your dream life? ", correctAnswer: true))

        list.append(Question(text: "You are an aspiring appla & android developer", correctAnswer: true))
